...
# Handy Creation
{
    ...
    "effects": create_item(
            factory_fn=lambda item_ctx: {
                "name": "Rough Object",
                "description": "A summoned object of common materials.",
                "weight_limit": item_ctx.source.get_progression_level("adventure", "Conjuror", 0),
                item_ctx.metadata[CONTEXT_OPTIONS.CHOSEN_ITEM]: True,  # TODO: placeholder until item creation support exists
            }
        ),
    "is_passive": False,
    "is_spell": True,
