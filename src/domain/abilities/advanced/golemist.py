...
# requires Enchanter 25, Animator 25. The rest is narrative and can be adjusted as needed.
...
build_job("Golemist", [
    ...
    # -------------------------
    {
        ...
        "effects": lambda c: scaled_derived_buff(
            stat="fate",
            scale_fn=lambda c: c.get_adventure_level_by_name("Golemist", 0),
        )(c),
        "description": "Your Fate increases with Golemist level.",
    },
