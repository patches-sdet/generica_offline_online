...
# requires Knight 25, Scout 25. The rest is narrative and can be adjusted as needed.
...
build_job("Detective", [
    ...
    # -------------------------
    {
        ...
        "effects": lambda c: scaled_derived_buff(
            stat="fate",
            scale_fn=lambda c: c.get_adventure_level_by_name("Detective", 0),
        )(c),
        "description": "Your Fate increases with Detective level.",
    },
