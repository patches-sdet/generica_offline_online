    ...
    # Cooking
    {
        ...
        "effects": lambda ctx: [
            skill_check(
                ability="Cooking",
                stat="wisdom",
                difficulty=lambda ctx, target: FOOD_DIFFICULTIES[ctx.require_option(CONTEXT_OPTIONS.PRODUCT_TYPE)],
                on_success=[
                    create_item(
    ...
    # Level 5
    {
        ...
        "effects": [
            skill_check(
                ability="Freshen",
                stat="luck",
                difficulty=lambda ctx, target: FOOD_DIFFICULTIES[ctx.require_option(CONTEXT_OPTIONS.TARGET_FOOD_AGE)],
                on_success=[
                    buff(
